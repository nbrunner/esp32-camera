...
static inline _Bool libjpeg_jpeg_to_rgb565(const uint8_t *jpeg_data, uint32_t jpeg_size, uint8_t *outbuffer)
{
    return libjpeg_decode(jpeg_data, jpeg_size, COLOR_TYPE_RGB565, outbuffer, NULL, NULL);
}

static inline _Bool libjpeg_jpeg_to_rgb888(const uint8_t *jpeg_data, uint32_t jpeg_size, uint8_t *outbuffer)
{
    return libjpeg_decode(jpeg_data, jpeg_size, COLOR_TYPE_RGB888, outbuffer, NULL, NULL);
}
